...
export function MenubarDemo() {
    ...
    return (
        <Menubar.Root className="flex rounded-md bg-white p-[3px] shadow-[0_2px_10px] shadow-zinc-200">
            <Menubar.Menu>
                <Menubar.Trigger className="flex select-none items-center justify-between gap-0.5 rounded px-3 py-2 font-medium leading-none text-violet-600 outline-none data-[highlighted]:bg-violet-50 data-[state=open]:bg-violet-50">
                    File
                </Menubar.Trigger>
                <Menubar.Portal>
                    <Menubar.Content
            ...
            <Menubar.Menu>
                <Menubar.Trigger className="flex select-none items-center justify-between gap-0.5 rounded px-3 py-2 font-medium leading-none text-violet-900 outline-none data-[highlighted]:bg-violet-50 data-[state=open]:bg-violet-50">
                    Edit
                </Menubar.Trigger>
                <Menubar.Portal>
                    <Menubar.Content
